...
| `GATEFORGE-ADMIN-PORTAL-CONTROL-TOWER.md` | **Control Tower** product direction: operational modules, ADM-xxx backlog (P0/P1/P2), Given/When/Then acceptance criteria, suggested SQLite data model, API outline, 5-phase roadmap, read-only v1 guardrails, n8n positioning | **Read second** — positioning, trust-layer framing, backlog, and acceptance criteria used for v1 planning |
...
| `GATEFORGE-ADMIN-PORTAL-EXTENDED-IMPLEMENTATION.md` | Extended implementation guide for Category G features | When you are implementing any Category G feature |
